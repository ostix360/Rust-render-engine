//! Typed uniform wrapper around the classic shaded mesh shader.
...
impl ClassicShader {
    /// Creates the classic shader wrapper and prepares its typed uniform handles.
    ...
    /// Uploads the model transformation matrix uniform.
    ...
    /// Uploads the mesh color uniform.
...
impl Shader for ClassicShader {
    ...
    /// Caches all uniform locations needed by the classic shader wrapper.
